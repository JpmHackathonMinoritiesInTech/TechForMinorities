...
public class Populator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        SelfDirected selfDirectedResource5 = new SelfDirected("Youtube", "There are a huge number of tutorial videos that can help you along no matter what stage you are at in your learning journey.", "https://youtube.com", "Free");
        ...
        Mentors mentor1 = new Mentors("https://pspdfkit.com/assets/images/blog/2017/women-in-software-development/rita-working-d49c61e5.jpg", "Naomi Negash", "naomi.negash@email.com", "https://linkedin.com/naominegash", "English, Farsi", "Bootcamp", "Hi there! I'm Naomi. I moved to the states when I was 26. Unfortunately, my computer science degree was not recognized. I did not want to spend another 4 years in school. A bootcamp was my best option. My journey has given me a passion to help immigrant manouver the tech realm.");
        mentorsRepo.save(mentor1);

        Mentors mentor2 = new Mentors("https://thumbs.dreamstime.com/b/smiling-african-american-man-writing-programming-code-portrait-developer-looking-camera-typing-keyboard-190244437.jpg", "Timothy Jones", "timothy.jones@email.com", "https://linkedin.com/timothyjones", "English, Some Spanish", "Bootcamp", "Hi there. My name is Timothy Jones. I started off in finance with a degree from The Ohio State University. After collaborating on a project that required me to understand some of the coding logic I realized I wanted to know more. Enroll in a bootcamp helped me emensly with my career switch. Don't be afraid to make a change. I'm so happy I did!");
        mentorsRepo.save(mentor2);

        Mentors mentor3 = new Mentors("https://www.bloomberg.com/features/2016-howard-university-coders/img/feat_howard05__01.jpg", "Malcolm Webb", "malcolm.webb@email.com", "https://linkedin.com/malcolmwebb", "English, Italian", "Bootcamp", "Hello! My name is Malcolm. At the age of 36 I decided to take a chance on myself and enrolled in a computer coding bootcamp. With no prior college education, who would have thought that I'd be a full stack developer?! If I can do it, trust me, so can you!");
        mentorsRepo.save(mentor3);

        Mentors mentor4 = new Mentors("https://thumbs.dreamstime.com/b/hispanic-software-developer-tying-keyboard-portrait-confident-young-male-programmer-desk-working-home-160369419.jpg", "Mark Sanchez", "mark.sanchez@email.com", "https://linkedin.com/marksanchez", "Spanish, English, Portuguese", "Self-taught", "Hello, I'm Mark. I'm living proof anyone can be successful in tech. It's not easy, but possible. With today's resources, it is even more possible. Speaking of resources, you've got one right here!");
